...
public static class DraftInvoiceFactory
{
    public static DraftInvoice Create(AggregationReadyEvent evt, IReadOnlyList<RawTransaction> txs)
    {
        var draft = new DraftInvoice
        {
            ...
            TransactionDate = evt.ReadyAt.Value,
        ...
        var grouped = txs.GroupBy(t => new { t.ProductName, t.UnitMeasure, t.NdsRate });
        ...
        draft.NdsRate = draft.Lines.Any() ? draft.Lines.First().NdsAmount : 0m;
